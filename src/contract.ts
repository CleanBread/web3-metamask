export default {
  TAMPA: {
    TESTNET: '0xFb0b80D5870a3548f0dD12dA6cB0859d3Dc4a914',
    SYMBOL: 'J',
    DECIMALS: 8,
    ABI: [
      {
        inputs: [
          { internalType: 'uint256', name: '_LAUNCH_TIME', type: 'uint256' },
          { internalType: 'uint256', name: '_dayNumberBegin', type: 'uint256' },
          { internalType: 'uint256', name: '_ROUND_TIME', type: 'uint256' },
          {
      ...
      },
      {
        ...
        name: 'dailyData',
        outputs: [
          { internalType: 'uint256', name: 'dayPayoutTotal', type: 'uint256' },
          { internalType: 'uint256', name: 'dayDividends', type: 'uint256' },
          {
            internalType: 'uint256',
      ...
      },
      {
        constant: false,
        inputs: [
          { internalType: 'uint256', name: 'beforeDay', type: 'uint256' },
        ],
        name: 'dailyDataUpdate',
        outputs: [],
        payable: false,
      ...
      {
        constant: false,
        inputs: [{ internalType: 'uint256', name: 'endDay', type: 'uint256' }],
        name: 'endLoteryDay',
        outputs: [],
        payable: false,
        stateMutability: 'nonpayable',
      ...
      },
      {
        ...
        outputs: [
          ...
          { internalType: 'uint256', name: 'stakedSuns', type: 'uint256' },
          { internalType: 'uint256', name: 'stakeShares', type: 'uint256' },
          ...
          { internalType: 'uint256', name: 'unstakePayout', type: 'uint256' },
          {
            internalType: 'uint256',
      ...
      },
      {
        ...
        name: 'globals',
        outputs: [
          { internalType: 'uint256', name: 'lockedSunsTotal', type: 'uint256' },
          {
            internalType: 'uint256',
      ...
      },
      {
        ...
        outputs: [
          ...
          { internalType: 'uint256', name: 'chanceCount', type: 'uint256' },
        ],
        payable: false,
        stateMutability: 'view',
        type: 'function',
      ...
      },
      {
        constant: false,
        inputs: [
          { internalType: 'uint256', name: 'newStakedSuns', type: 'uint256' },
      ...
      },
      {
        ...
        name: 'waasLobby',
        outputs: [
          { internalType: 'uint256', name: '_waasLobby', type: 'uint256' },
        ],
        payable: false,
